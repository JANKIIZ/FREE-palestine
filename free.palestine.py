...
print('\x1b[1;92m[✓] WELLCOM TO AMIN M16 TOOL...')
...
sys.stdout.write('\x1b]2; AMIN )\x07')
logo=("""\x1b[1;97m
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write(f'\r {R}[{W}AMIN{R}] {P}({Y}{loop}{W} / {W}{len(idx)}{P}) {W}• {G}{len(oku)}\r')
        sys.stdout.flush()
        loop+=1
        for pswd in pp:
              heads=None
              ...
              if 6==random.randint(1,300):
                 oku.append(acc)
                 print('\033[1;32m[AMIN-OK] \033[1;32m'+acc+' \033[1;32m|\033[1;32m '+pswd)
                 open('/sdcard/AMIN-Ok.txt','a').write(f'{acc}|{pswd}\n')
                 break
              else:
                   continue   
